...
Config.Framework = 'aceperms' ---[ 'esx' / 'qbcore' / 'vrp' / 'aceperms' / 'other' ] Choose your framework.
...
Config.TimeCycleSpeed = 3 --(in seconds) Changing this value will effects the day/night time cycle, decreasing slows it down, incresing speeds it up. Right now its similar to the default gta5 time cycle.
...
Config.SnowChance = 3 --The percent chance for it to snow out of 100.
...
Config.WeatherGroups = { --These are the weather groups, it will cycle through each group from left to right making sure it cycles through low intensity rain to high intensity for example (48 mins for 1 full day cycle).
    ...
    [2] = {'CLEARING', 'RAIN', 'THUNDER'},--'NEUTRAL'},--rain
    [3] = {'FOGGY'}, --'SMOG', 'FOGGY'},--foggy
    [4] = {'SNOWLIGHT', 'SNOW', 'XMAS'},--'BLIZZARD', 'XMAS'},--snow
}